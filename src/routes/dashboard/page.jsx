            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div className="card">
                    ...
                    <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
                        <p className="text-3xl font-bold text-slate-900 transition-colors dark:text-slate-50">25.154.778</p>
                ...
                <div className="card">
                    ...
                    <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
                        <p className="text-3xl font-bold text-slate-900 transition-colors dark:text-slate-50">Rp16.000.000</p>
                        <span className="flex w-fit items-center gap-x-2 rounded-full border border-blue-500 px-2 py-1 font-medium text-blue-500 dark:border-blue-600 dark:text-blue-600">
                            <TrendingUp size={18} />
                            12%
                        </span>
                    ...
                    <div className="card-body h-[300px] overflow-auto p-0">
                        {recentSalesData.map((sale) => (
                            ...
                            >
                                ...
                                <p className="font-medium text-slate-900 dark:text-slate-50">Rp{sale.total}</p>
                            </div>
                        ))}
                    </div>
                </div>
                            ...
                            <tbody className="table-body">
                                {topProducts.map((product) => (
                                    ...
                                    >
                                        ...
                                        <td className="table-cell">Rp{product.price}</td>
